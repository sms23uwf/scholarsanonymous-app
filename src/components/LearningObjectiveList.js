...
export const LearningObjectiveList = (props) => (
  <div className="content-container">
    <div className="list-header">
      <div className="show-for-mobile">Knowledge Area</div>
      <div className="show-for-mobile">Outcome</div>
      <div className="show-for-desktop" className="list-item__title" className="center">Knowledge Area</div>
